  ...
  return (
    <form className="space-y-2">
      ...
      <div className="flex items-center">
        <input id="option1" type="radio" name="child" value="1" className="form-radio text-blue-500" />
        <label htmlFor="option1" className="ml-2 text-blue-600 hover:text-blue-400"> {listQuestionnaire[0].child}</label>
      </div>
      <div className="flex items-center">
        <input id="option2" type="radio" name="adult" value="2" className="form-radio text-blue-500" />
        <label htmlFor="option2" className="ml-2 text-blue-600 hover:text-blue-400"> {listQuestionnaire[0].adult}</label>
      </div>
      <div className="flex items-center">
        <input id="option3" type="radio" name="parent" value="3" className="form-radio text-blue-500" />
